...
echo -e "\n[8/9] Building and starting Next.js container..."
docker compose build nextjs
docker compose up -d nextjs
sleep 5
docker logs nextjs | tail -10

echo -e "\n[9/9] Building and starting NPM container..."
docker compose build npm
docker compose up -d npm
sleep 5
docker logs npm | tail -10
